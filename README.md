...
I then created a **mouseXRatio** to return a normalised value between 0 and 1 for the mouse x-position. This allowed me to use this value later as an index for easing:
